...
var KTAppsUsersListDatatable = function () {
    var getUrl = document.getElementById('GetlistarPessoas').value;
    var getListarPessoas = [];
    console.log(getListarPessoas);
    console.log(getUrl);
    var _ListaPessoas = function () {
        return {
            data: {
                type: "remote",
                source: {
            ...
            columns: [
                {
                    ...
                    textAlign: 'left',
                    template: function (data) {
                        return '<span class="font-weight-bolder">' + data.nome + '</span>';
                    }
                },
                {
                    field: 'CPF',
                    title: 'CPF',
                    template: function (data) {
                        return '<div class="font-weight-bolder font-size-lg mb-0">' + data.cpf + '</div>';
                    }
                },
                {
                    field: 'Acçoes',
                    ...
                    template: function (data) {
                        return '\
                     <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2" title="Editar Dados">\
                            <span class="svg-icon svg-icon-md">\
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                        <rect x="0" y="0" width="24" height="24"/>\
                        ...
                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Deletar">\
                            <span class="svg-icon svg-icon-md">\
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                        <rect x="0" y="0" width="24" height="24"/>\
    ...
    return {
        init: function () {
            ...
            $('#kt_datatable').KTDatatable(_ListaPessoas());
        },
    };
}();
